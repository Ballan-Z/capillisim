...
or reject it, and a projector highlighting that exact slot at 1:1 scale) did not
turn up in this survey as an integrated system for mosaics. That integration is
...
Nothing found in this survey combines all three of:
...
as a single interactive, incremental build loop. That combination is the part
worth building here.
